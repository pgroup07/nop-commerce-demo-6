Feature: Register Page  Test
  ...
  Scenario: Verify That FirstName LastName Email Password And ConfirmPassword Fields Are Mandatory
    ...
    And User Verify the error message "First name is required."
    And User Verify the error messagee "Last name is required."
    And User Verify the error messages "Email is required."
    And User Verify the error messagess "Password is required."
    Then User Verify the error messagees "Password is required."
